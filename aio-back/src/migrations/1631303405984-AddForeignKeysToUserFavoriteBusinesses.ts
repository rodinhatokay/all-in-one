...
export class AddForeignKeysToUserFavoriteBusinesses1631303405984 implements MigrationInterface {
    name = 'AddForeignKeysToUserFavoriteBusinesses1631303405984'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
          ...
          CREATE TABLE "favorite_businesses" (
              ...
              CONSTRAINT "PK_8e00b134db84f47b551b4e083f6" PRIMARY KEY ("userId", "businessId")
          );
          ...
          ALTER TABLE "favorite_businesses" ADD CONSTRAINT "FK_50256e61c526b65b58a6ef5eb45" FOREIGN KEY ("businessId") REFERENCES "business"("id") ON DELETE CASCADE;
        `);
      }
