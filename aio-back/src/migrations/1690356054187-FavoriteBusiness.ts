...
export class FavoriteBusiness1690356054187 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
          `CREATE TABLE "user_favorite_businesses" ("userId" integer NOT NULL, "businessId" integer NOT NULL, CONSTRAINT "PK_user_favorite_businesses_userId_businessId" PRIMARY KEY ("userId", "businessId"))`
        );
        await queryRunner.query(
