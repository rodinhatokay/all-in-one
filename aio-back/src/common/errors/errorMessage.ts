export enum ErrorMessages {
	...
	UserOrBusinessNotFound = 'User or business not found.',
	BusinessNotFound = 'Business does not exists',
	BusinessAlreadyInFavorite = 'Business is already in the favorites list.',
	BusinessIsNotInFavorite = 'Business is not in the favorites list.',
